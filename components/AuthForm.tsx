...
export function AuthForm({ mode, googleEnabled=false, callbackUrl="/dashboard" }: { mode: "login"|"register"; googleEnabled?: boolean; callbackUrl?: string }) {
